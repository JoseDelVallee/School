...
# Graficar la varianza de los incrementos en función del tiempo t (sin puntos)
plt.figure(figsize=(8, 6))
plt.plot(times, varianzas_incrementos, linestyle='-', color='b', label='Varianza de los Incrementos')
plt.title('Varianza de los Incrementos en Función del Tiempo')
plt.xlabel('Tiempo (t)')
plt.ylabel('Varianza de los Incrementos')
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.show()
